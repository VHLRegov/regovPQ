...
const run = async () => {
    ...
    const endpoint = process.env.AGENT_ENDPOINT ?? (await connect(9000))
    ...
    const httpInbound = new HttpInboundTransport({ port: 9001});
    ...
    logger.info(`Test agent online at port 9000`)
